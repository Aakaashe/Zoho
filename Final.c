...
int main()
{
    ...
    int lineiter=0,len=0,id=0,businessBaseRate=2000,economyBaseRate=1000,amount=0,ch;
    ...
    do
    {
        int seatrow,seatcol,noOfSeats,flightClass,meal,tempid,temprow,tempcol,tempclass;
        char col,tempchar,tempcolchar;
